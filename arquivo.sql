...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama, mesa & banho'),(4,'Eletrônicos'),(5,'Jardingem'),(6,'Decoração'),(7,'Perfumaria'),(8,'Alimentação'),(9,'Pets'),(10,'Moda');
...
INSERT INTO `cidade` VALUES (1,'Uberlândia',1),(2,'São Paulo',2),(3,'Jundiaí',2);
...
CREATE TABLE `cliente` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `cpf_ou_cnpj` varchar(100) DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (1,'50032665024','maria@gmail.com','Maria Silva',1),(2,'75365423000104','blira@gmail.com','Bruno Lira',2),(3,'08385323066','pbellemo@gmail.com','Patricia Bellemo',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','38220834','Apto 303','Rua das Flores','300',1,1),(2,'Centro','39777012','Sala 800','Avenida Matos','105',2,1),(3,'Vila Brasilina','04162050','','Rua Kitizo Utiyama','308',2,2),(4,'Vila Progresso','13202151','','Rua Irmã Alida','20',3,3);
...
--
-- Table structure for table `estado_cidades`
--

DROP TABLE IF EXISTS `estado_cidades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `estado_cidades` (
  `estado_id` int(3) NOT NULL,
  `cidades_id` int(3) NOT NULL,
  UNIQUE KEY `UK_gijjfjo51s66b3d93dqfknv42` (`cidades_id`),
  KEY `FKb2ry2y5u2495mmteeveyt6ifd` (`estado_id`),
  CONSTRAINT `FKb2ry2y5u2495mmteeveyt6ifd` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`),
  CONSTRAINT `FKdsru97k6bsynqe9wc4teuap59` FOREIGN KEY (`cidades_id`) REFERENCES `cidade` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `estado_cidades`
--

LOCK TABLES `estado_cidades` WRITE;
/*!40000 ALTER TABLE `estado_cidades` DISABLE KEYS */;
INSERT INTO `estado_cidades` VALUES (1,1),(2,2),(2,3);
/*!40000 ALTER TABLE `estado_cidades` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `item_pedido` VALUES (0,2000,1,1,1),(0,80,2,1,3),(100,800,1,2,2),(100,2000,1,3,1),(0,800,1,4,2);
...
INSERT INTO `pagamento` VALUES (1,2),(2,1),(3,2),(4,3);
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2017-10-20 02:00:00',2),('2017-07-20 12:11:00','2017-07-20 12:11:00',3);
...
CREATE TABLE `pagamento_com_cartao` (
  `numero_de_parcelas` int(3) DEFAULT NULL,
  `pedido_id` int(3) NOT NULL,
  PRIMARY KEY (`pedido_id`),
...
INSERT INTO `pagamento_com_cartao` VALUES (6,1),(4,4);
...
CREATE TABLE `pedido` (
  ...
  `cliente_id` int(3) DEFAULT NULL,
  `endereco_de_entrega_id` int(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `pedido` VALUES (1,'2017-09-30 13:32:00',1,1),(2,'2017-10-10 22:35:00',1,2),(3,'2017-06-19 18:02:00',2,3),(4,'2017-01-03 18:20:00',3,4);
...
INSERT INTO `telefones` VALUES (1,'993129762'),(1,'36283956'),(2,'969192721'),(3,'998719177');
...
-- Dump completed on 2020-07-04 16:30:43
